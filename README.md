...
新增BING每日壁纸功能，服务器每天0:05自动下载最新BING壁纸，一键即可设置为桌面背景
...
9. 侧边分组目录导航功能（2026.04）
新增精致的左侧分组导航条，提升长页面浏览体验：

**功能特点：**
- 🎯 **智能显示**：鼠标移动到左侧边缘（60px区域）自动显示，离开后1.5秒淡出隐藏
- ✨ **实时高亮**：当前所在分组的圆点高亮显示，跟随滚动位置实时更新
- 🖱️ **快速跳转**：点击任意圆点平滑滚动到对应分组
- 💫 **半透明提示**：悬停显示分组名称，采用毛玻璃半透明效果
- 📱 **响应式设计**：移动端自动隐藏，不占用屏幕空间
- 🎨 **优雅设计**：竖线+圆点布局，简洁美观，支持自定义间距

**技术实现：**
- 监听滚动容器事件，精准计算分组位置
- 动态更新当前索引，高亮状态实时同步
- CSS Transition 实现平滑淡入淡出动画
- 媒体查询适配移动端设备
